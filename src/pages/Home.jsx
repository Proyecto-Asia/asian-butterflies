      ...
      <section
        ...
        <div className="max-w-2xl order-1 md:order-2">
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-2xl text-center md:text-left">
            <p className="text-sm md:text-base leading-relaxed opacity-0 animate-fade-in animation-delay-500">
              Las mariposas desempeñan un{" "}
              <strong className="text-green-700">papel fundamental como polinizadores.</strong>
              <br />
              <br />
