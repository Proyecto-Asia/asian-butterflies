...
function StatusSelector({FormData, value, onChange}) {
  ...
  return (
    <select
      ...
      value={value}
      onChange={onChange}
      className="rounded-md border border-mint-green-200 h-10 w-60 mt-2 text-mint-green-700 text-xs focus:border-mint-green-600 focus:outline-2vw outline-mint-green-200 px-3 py-2 mb-3"
    >
